...
// Mirrors BlockFloatingSpecialFlower

import java.util.ArrayList;
import java.util.List;
import java.util.Random;

import net.fuzzycraft.botanichorizons.addons.item.ItemBlockFloatingSparkFlower;
...
import net.fuzzycraft.botanichorizons.addons.crafting.recipe.SparkFloatingFlowerRecipe;
...
public class BlockFloatingSparkFlower extends BlockFloatingFlower implements ISpecialFlower, IWandable, ILexiconable, IWandHUD {
    
    public static String NAME = "blockFloatingSparkFlower";

	public BlockFloatingSparkFlower() {
		super(NAME);

		GameRegistry.addRecipe(new SparkFloatingFlowerRecipe());
		RecipeSorter.register("botania:floatingSparkFlower", SparkFloatingFlowerRecipe.class, Category.SHAPELESS, "");
	}
	...
	public void getSubBlocks(Item item, CreativeTabs tab, List<ItemStack> list) {
		for(String s : BotaniaAPI.subtilesForCreativeMenu) {
			list.add(ItemBlockSparkFlower.ofType(new ItemStack(item), s));
			if(BotaniaAPI.miniFlowers.containsKey(s))
				list.add(ItemBlockSparkFlower.ofType(new ItemStack(item), BotaniaAPI.miniFlowers.get(s)));
		}
	}
	...
	public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z) {
		...
		return ItemBlockSparkFlower.ofType(new ItemStack(world.getBlock(x, y, z)), name);
	}
	...
	public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune) {
		...
		if(tile != null) {
			...
			list.add(ItemBlockSparkFlower.ofType(new ItemStack(world.getBlock(x, y, z)), name));
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		return ((TileSparkFlower) world.getTileEntity(x, y, z)).onBlockActivated(world, x, y, z, player, side, hitX, hitY, hitZ) || super.onBlockActivated(world, x, y, z, player, side, hitX, hitY, hitZ);
	}
	...
	protected void register(String name) {
		GameRegistry.registerBlock(this, ItemBlockFloatingSparkFlower.class, name);
	}

	@Override
	public TileMod createNewTileEntity(World world, int meta) {
		return new TileFloatingSparkFlower();
	}
